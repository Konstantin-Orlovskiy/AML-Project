...
#finalSet.to_csv(r'D:\Study\Applied Machine Learning\Project\ScaledDataSet.csv', index=False)

# Clear out unnecessary variables
del classSet, origSetCols, nameDictionary, objCols
